...
kmfunc <- function(data = edata %>% filter(survpop), time, event, eventcr = NULL, eventname, yposplus = rep(0, 5)) {
  ...
  mtext("No. at risk", side = 1, line = 3, at = -51, adj = 0, cex = 1)

  mtext("0", side = 1, line = 4, at = -40, adj = 0, cex = 1)
  mtext("1", side = 1, line = 5, at = -40, adj = 0, cex = 1)
  mtext("2", side = 1, line = 6, at = -40, adj = 0, cex = 1)
  mtext("3", side = 1, line = 7, at = -40, adj = 0, cex = 1)
  mtext("4+", side = 1, line = 8, at = -40, adj = 0, cex = 1)
